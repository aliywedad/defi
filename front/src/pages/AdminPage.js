                ...
                <ul className="menu-inner py-1">
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            ...
                            <Link  onClick={() => { setrender('Etudiant') }}   className="menu-link" style={{ textDecoration: 'none' }}>
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link onClick={() => { setrender('Jery') }} className="menu-link" style={{ textDecoration: 'none' }}>
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link  onClick={() => { setrender('Admin') }} className="menu-link" style={{ textDecoration: 'none' }}>
