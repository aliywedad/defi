...
function Sidebar_etudiant({prop}) {
                ...
                <ul className="menu-inner py-1">
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            ...
                            <Link to='/ListeDefis' className="menu-link" style={{ textDecoration: 'none' }}>
                            <div data-i18n="Basic">Liste des defis</div>
                            </Link>
                        </a>
                    </li>
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link to={`/CreeDefi`}className="menu-link" style={{ textDecoration: 'none' }}>
                            <div data-i18n="Basic">Crée un défi</div>
                            </Link>
                        </a>
                    </li>
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link to={`/Noter`}className="menu-link" style={{ textDecoration: 'none' }}>
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link to={`/ListeEquipes`}className="menu-link" style={{ textDecoration: 'none' }}>
                            <div data-i18n="Basic">Liste des equipes</div>
                            </Link>
                        </a>
                    </li>
...
export default Sidebar_etudiant;
