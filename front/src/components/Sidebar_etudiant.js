                ...
                <ul className="menu-inner py-1">
                    ...
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            ...
                            <Link to='/CreeEquipe' className="menu-link" style={{ textDecoration: 'none' }}>
                            <div data-i18n="Basic">Cree une equipe</div>
                            </Link>
                        </a>
                    </li>
                    <li className="menu-item">
                        <a href="" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-collection"></i>
                            <Link to={`/RenderTravail`}className="menu-link" style={{ textDecoration: 'none' }}>
                            <div data-i18n="Basic">rendre le travail</div>
                            </Link>
                        </a>
                    </li>
